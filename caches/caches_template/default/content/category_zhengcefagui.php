<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><?php include template("content","myhead"); ?>
    ...
    <link rel="stylesheet" href="<?php echo CSS_PATH;?>zhengchefagui.css">
   <div class="banner">
 ...
 <div class="con-box">
   <div class="con">
       ...
       <!--法规循环处 A标签-->
       <div class="right">
           <span class="tit">相关法规</span>
           <a href="#" class="list">111</a>
           <a href="#" class="list">111</a>
           <a href="#" class="list">111</a>
           <a href="#" class="list">111</a>
           <a href="#" class="list">111</a>
   ...
   <div class="more_box">
       <ul class="more_left">
           <li class="left_img"></li>
           <li class="left_tit">批准文号查询</li>
           <li class="left_more">
               <a href="#">查看详情 ></a>
           </li>
       </ul>
